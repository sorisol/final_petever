        ...
        <section class="content-wrap">
            ...
            <div class="content">
            	 <form name="boardFrm" id="boardFrm"
                    ...
                    <textarea id="board-content" name="aniBoContent" rows="20"></textarea>
                        <div class="pet-info">
                            <table class="pet-info">t
                           		<tr>
	                         		<th>특징</th>
	                         		<td>
                            	...
                            	<tr>
                            		<th>실종/발견 날짜</th>
                            		<td>
                            			<input type="date" name="aniBoMissDate">
                            		</td>
                            	</tr>
                                <tr>
                            		<th>지역</th>
                            		<td>
                            			<input type="text" name="aniBoLocal" />
                            		</td>
                            	</tr>
                                <tr>
                                    <th>동물종류</th>
                                    <td>
                                        <input type="checkbox" name="aniBoType" id="개">
                                        <label for="개">개</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoType" id="고양이">
                                        <label for="고양이">고양이</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoType" id="기타">
                                ...
                                <tr>
                                    <th>털길이</th>
                                    <td>
                                        <input type="checkbox" name="aniBoHair" id="단모종">
                                        <label for="단모종">단모종</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoHair" id="장모종">
                                ...
                                <tr>
                                    <th>나이</th>
                                    <td>
                                        <input type="checkbox" name="aniBoAge" id="0~2">
                                        <label for="0~2">0~2</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoAge" id="3~5">
                                        <label for="3~5">3~5</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoAge" id="6~8">
                                        <label for="6~8">6~8</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoAge" id="8~">
                                ...
                                <tr>
                                    <th>성별</th>
                                    <td>
                                        <input type="checkbox" name="aniBoGender" id="암컷">
                                        <label for="암컷">암컷</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoGender" id="수컷">
                                ...
                                <tr>
                                    <th>무게</th>
                                    <td>
                                        <input type="checkbox" name="aniBoSize" id="~5">
                                        <label for="~5">5 미만</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoSize" id="5~10">
                                        <label for="5~10">5~10</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoSize" id="10~15">
                                        <label for="10~15">10~15</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoSize" id="15~">
                                ...
                                <tr>
                                    <th>털색</th>
                                    <td>
                                        <input type="checkbox" name="aniBoColor" id="흰색">
                                        <label for="흰색">흰색</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoColor" id="검은색">
                                        <label for="검은색">검은색</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoColor" id="회색">
                                        <label for="회색">회색</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="aniBoColor" id="갈색">
