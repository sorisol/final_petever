...
<body>
    ...
    <p><span>· 제목</span> : ${reviewBoard.rewBoTitle}</p>
    <p><span>· 글쓴이</span> : ${reviewBoard.userId}</p>
...
$("#submit-btn").on("click", function() {
	var rep = {
		aniBoId: ${reviewBoard.rewBoId},
		userId: '${reviewBoard.userId}',
	...
	$.ajax({
		url: "${pageContext.request.contextPath}/reviewBoard/report.do",
