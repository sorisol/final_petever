        ...
        <section class="content-wrap">
            ...
            <div class="content">
            	 <form name="boardFrm" id="boardFrm" method="post"
            	 	action="${pageContext.request.contextPath}/reviewBoard/updateBoard.do"
            	 	 enctype="multipart/form-data">
                    <h1>글쓰기</h1>
                  	<input type="hidden" name="userId" value="${reviewBoard.userId}" />
                    <div class="title">
	                    <input type="text" name="rewBoTitle" value="${reviewBoard.rewBoTitle}">         
	                    <input type="hidden" name="rewBoId" value="${reviewBoard.rewBoId}" />
                    </div>

                    <textarea id="board-content" name="rewBoContent" rows="50">
