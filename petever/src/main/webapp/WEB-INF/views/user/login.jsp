...
<jsp:include page="/WEB-INF/views/common/header.jsp"/>
   <section>
        <div class="login">
            ...
            <a id="custom-login-btn" style="margin: 0 auto; width: 232px; display: block;" href="https://kauth.kakao.com/oauth/authorize?client_id=94eafcad9cc336603158ae0aa47f30a3&redirect_uri=${pageContext.request.contextPath}/user/kakaologin.do&response_type=code">
